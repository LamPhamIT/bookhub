    ...
    <div id="top-header">
        <div class="container">
            <ul class="header-links pull-left">
                <li><a href="#"><i class="fa fa-phone"></i> 0385979034</a></li>
                <li><a href="#"><i class="fa fa-envelope-o"></i> lampt.22it@vku.udn.vn</a></li>
                <li><a href="#"><i class="fa fa-map-marker"></i> thôn Trung Đàn, xã Tam Đại, Phú Ninh, Quảng Nam</a></li>
            </ul>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="<c:url value='/template/web/img/shop03.png'/>" alt="">
                    </div>
                    <div class="shop-body">
            ...
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <p>Chong chóng quay khi trời có gió anh chỉ cười khi nơi đó có em. Hehehe</p>
